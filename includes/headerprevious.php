...
<div class="header">
      ...
      <div class="heder-bottom" style="background-color: #222;">
        <div class="container">
          <div class="logo-nav">
            <div class="logo-nav-left">
              <h1><a href="index.php"><img alt="StandTall_Logo" src="images/favicon.png"></a></h1>
            </div>
            <div class="logo-nav-left1">
              ...
              <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                <ul class="nav navbar-nav" style="margin-left: 228px; text-transform: UPPERCASE;">
